...
<form action="/journal/feedback/send" method="POST">
 ...
 <p><input placeholder="Введите вашу электронную почту"
name="email"></p>
 <p><textarea name="comment" placeholder="Введите ваш
комментарий"></textarea></p>
 <p><input type="button" onclick="sendData()" value="Отправить"><input
type="reset" value="Очистить"></p>
</form>
<script>
 {
 "use strict";
